...
if [[ $(command -v apt) ]]; then
    if [[ $(lsb_release -is)=="Debian" ]]; then
        ...
        programExists "vim" "apt-get install vim-nox" 
        gem install neovim
        npm install -g neovim
        programExists "gcc" "apt-get install gcc"
        programExists "gdb" "apt-get install gdb" 
        programExists "clang" "apt-get install clang"
        programExists "python3" "apt-get install python3" 
        programExists "pip" "apt-get install python-pip"
        programExists "pip3" "apt-get install python3-pip"
        programExists "node" "apt-get install nodejs"
        # In Debian 9 npm is integrated in nodejs..
        programExists "npm" "apt-get install npm"
        programExists "ctags" "apt-get install exuberant-ctags" 
        programExists "php" "apt-get install php" 
        programExists "lua" "apt-get install lua5.3 liblua5.3" 
        pythonPackageExists "flake8" "pip3 install flake8"
        pythonPackageExists "powerline-status" "pip3 install powerline-status"
        nodePackageExists "jshint" "npm install -g jshint" 
    ...
    if [[ $(lsb_release -is)=="Ubuntu" ]]; then
        ...
        programExists "clang" "apt-get install clang"
        programExists "python3" "apt-get install python3" 
        programExists "pip" "apt-get install python3-pip"
        programExists "pip3" "apt-get install python3-pip"
        programExists "node" "apt-get install nodejs"
        programExists "npm" "apt-get install npm"
        programExists "ctags" "apt-get install exuberant-ctags" 
    ...
    if [[ $(lsb_release -is)=="LinuxMint" ]]; then 
        ...
        pythonPackageExists "powerline-status" "sudo pip3 install powerline-status"
